...
export default function UploadOverlay({ isOpen }) {
            ...
            >
                ...
                <div className="flex flex-col items-center justify-center">
                    <label htmlFor="file-upload" className="cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-12 h-12 text-[#0A4A6E]">
                    ...
                    <p className="mt-2 text-[#0A4A6E] font-medium">Choose photos</p>
                </div>
            </div>
        </div>
    );
